...
class TreeNode:
    def __init__(self, split_step=0.1, split_wait=100, hb_delta=0.01, tie_thresh=0.05, rnd=False, subspaces=False,
        ...
        self.nb_pred = cu.naive_bayes_log_prob if self.log_prob else cu.naive_bayes_prob
    ...
    def predict_prob(self, x):
        if not self.stats:
            ...
            maj_probs = cu.majority_class_prob(self.stats.cls_counts, self.stats.get_cls_count())

...
class StatUtilsTests(unittest.TestCase):
    ...
    def test_split_statistics(self):
        ...
        self.assertEqual(st_left.get_cls_count(1), 10.0)
        for att_idx in stat_atts:
            self.assertEqual(st_left.get_estimator(att_idx, 0).get_count(), 100.0)
            self.assertEqual(st_left.get_estimator(att_idx, 1).get_count(), 100.0)
        ...
        self.assertEqual(st_right.get_cls_count(1), 90.0)
        for att_idx in stat_atts:
            self.assertEqual(st_right.get_estimator(att_idx, 0).get_count(), 100.0)
            self.assertEqual(st_right.get_estimator(att_idx, 1).get_count(), 100.0)

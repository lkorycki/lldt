...
cls_names = {
    ...
    'CIFAR20C': lambda: DataLabelsUtils.get_dataset_labels(data_col.get('CIFAR20C-TRAIN')),
    ...
    'IMAGENET20A': lambda: [im200_labels[i] for i in [i * 10 - 1 for i in range(1, 21)]],
    'IMAGENET20B': lambda: [im200_labels[i] for i in [i * 10 - 5 for i in range(1, 21)]],
